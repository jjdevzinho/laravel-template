<div class="absolute z-10 w-full top-0 left-0 hidden" js-id="navbarMain">
    <div class="container mx-auto" style="background: rgba(0, 0, 0, 0.5)">
        <div class="flex flex-col h-screen w-60 bg-base-100 text-content-200">
            <div class="flex items-center justify-between h-14 bg-base-200">
                <img class="h-8 m-2" src="https://img.superlistas.site/img/logo.png" alt="logo">
                <button class="p-2" js-action="btnNavbarMain">
                    <i class="fas fa-times text-xl text-danger"></i>
                </button>
            </div>
                    ...
                    <ul class="pt-2 pb-4 space-y-1 text-sm">
                        <li class="rounded-sm">
                            <a href="#" class="flex items-center p-2 space-x-3 rounded-md">
                                <i class="fas fa-home text-lg text-primary"></i>
                                <span>Home</span>
                            </a>
                        </li>
                        <li class="rounded-sm">
                            <a href="#" class="flex items-center p-2 space-x-3 rounded-md">
                                <i class="fas fa-search text-lg text-primary"></i>
                                <span>Search</span>
                            </a>
                        </li>
                        <li class="rounded-sm">
                            <a href="#" class="flex items-center p-2 space-x-3 rounded-md">
                                <i class="fas fa-comments text-lg text-primary"></i>
                                <span>Chat</span>
                            </a>
                        </li>
                        <li class="rounded-sm">
                        ...
                        <li class="rounded-sm bg-gray-100 text-gray-900">
                            <a href="" class="flex items-center p-2 space-x-3 rounded-md">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                                    class="w-5 h-5 fill-current">
                                    <path
            ...
            <div class="flex items-center p-2 mt-12 space-x-4 justify-self-end">
                ...
                <div>
                    <h2 class="text-lg font-semibold text-content-100">Dev Tenshi</h2>
                    <span class="flex items-center space-x-1">
                        <a href="#" class="text-xs hover:underline text-content-200">Ver Perfil</a>
                    </span>
                </div>
            </div>
        </div>
...
@push('scripts')
    <script>
        $('[js-action="btnNavbarMain"]').click(function() {
            $('[js-id="navbarMain"]').fadeToggle(300).toggleClass('hidden');
        });
    </script>
@endpush
